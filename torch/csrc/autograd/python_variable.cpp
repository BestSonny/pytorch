...
PyObject *THPVariable_get_backwards_pre_hooks(THPVariable *self, void *unused)
{
  HANDLE_TH_ERRORS
...
int THPVariable_set_backwards_pre_hooks(THPVariable *self, PyObject *obj, void *unused)
{
  HANDLE_TH_ERRORS
  THPUtils_assertRet(-1, obj, "Deletion of _backwards_pre_hooks not allowed!");
  if (obj == Py_None) {
    obj = nullptr;
  }
  Py_XINCREF(obj);
